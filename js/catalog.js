...
function populateForm() {
  ...
  //COMPLETED!!! TODO: Add an <option> tag inside the form's select for each product
...
function handleSubmit(event) {
  ...
  //COMPLETED!!! TODO: Prevent the page from reloading
...
function addSelectedItemToCart() {
  ...
  console.log('item selevted', item);
